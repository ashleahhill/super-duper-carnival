...
function webpackConfig(options) {
  ...
  const isVerbose = !!options.webpackVerbose;
  const useHMR = !!options.HMR; // Hot Module Replacement (HMR)
  ...
  const config = {
    ...
    entry: [
      ...
      '!!style!css!sass!./core/styles/global.scss',
    ...
    plugins: [
      ...
      new webpack.DefinePlugin({
        ...
        __DEV__: isDebug,
        darkSky: isDebug ? '' : JSON.stringify(options.darkSky)
      }),
